...
Foi elaborado um documento com o levantamento e a estruturação das informações necessárias para compreender o cenário apresentado, seguindo os princípios da etapa de **Business Understanding** do CRISP-DM.

A atividade contempla a reflexão sobre:
...
A compreensão construída nesta unidade serve como base para as etapas seguintes do processo de análise de dados, orientando quais informações devem ser consideradas, quais perguntas precisam ser investigadas e quais análises podem contribuir para responder ao problema proposto.
